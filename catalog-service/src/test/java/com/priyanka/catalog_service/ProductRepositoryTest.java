...
@Sql("/test-data.sql")
@Import(TestcontainersConfiguration.class)  //if testing only repository then dont use this with db container , there can be other containers such as rabbitmq
